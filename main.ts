...
overworld.onMapLoaded(function (overworldColumn, overworldRow, map2) {
    ...
    if (tiles.getTilesByType(sprites.dungeon.floorDarkDiamond).length > 0) {
        ...
        for (let grass2 of tiles.getTilesByType(sprites.skillmap.islandTile4)) {
            ...
            tiles.placeOnTile(mySprite, grass2)
        }
    }
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleOuterSouth0, function (sprite3, location) {
    overworld.setOverworld16(universeB)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleOuterEast0, function (sprite4, location2) {
    if (gotOrders) {
